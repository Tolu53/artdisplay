...
{isOpen  && (<div className='bg-black w-full h-[30vw] p-5 absolute bottom-0 justify-center items-center duration-500 flex'>
<div className='flex justify-center items-center text-white  duration-1000'>
          ...
          <div key={id} className=' px-4 cursor-pointer first-letter:capitalize font-medium
           hover:scale-105 duration-1000 list-none  '>
            <a >{title}</a>
            <img src={src} alt={title} className=' h-[15vw] object-cover aspect-video ' />
            </div>
        ))
        }
            </div>
